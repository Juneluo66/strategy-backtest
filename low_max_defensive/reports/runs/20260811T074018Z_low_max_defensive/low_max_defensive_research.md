...
- Residual after vol control: MAX_IS_VOLATILITY_PROXY.
...
- LOW_MAX vs SPLV: sharpe 0.603 vs 0.612; cagr 0.083 vs 0.085; vol 0.152 vs 0.153 — near-parity favors low-vol proxy.
- MAX exclusion adds no positive incremental Sharpe inside vol buckets, and/or Low-MAX matches SPLV — treat as volatility proxy, not a distinct MAX defensive signal.
