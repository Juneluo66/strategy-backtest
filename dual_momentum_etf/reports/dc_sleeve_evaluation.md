...
- 20%/40% D+C sleeves cut absolute MaxDD vs 100% SPY with only a small CAGR drag, and avoid 100% D+C's ~73% relative drawdown. Use as a **defensive overlay on a SPY core**, not as a replacement for SPY. Note: relative-NAV can remain underwater for long stretches after crisis relative peaks (e.g. 80/20 max rel-DD 21.8%), so this is not a free lunch.

- 20% D+C (80/20): MaxDD cut 8.51% vs SPY; CAGR lag 0.14%; max rel-DD -21.83%; rel underwater 210m (ongoing)
- 40% D+C (60/40): MaxDD cut 17.66% vs SPY; CAGR lag 0.37%; max rel-DD -39.45%; rel underwater 210m (ongoing)
...
|---|---:|---:|---|---:|---:|---:|
| 100% SPY | 0.00% | n/a | no | 0.00% | 0.00% | 0.00% |
...
| 100% D+C | -17.97% | 37.22% | 1.52% | 0.04% |
| 80/20 SPY/D+C | -46.68% | 8.51% | 0.14% | 0.02% |
| 60/40 SPY/D+C | -37.53% | 17.66% | 0.37% | 0.02% |
| 40/60 SPY/D+C | -27.14% | 28.05% | 0.67% | 0.02% |
...
| 100% D+C | 51.50% | 6.95% | 15.95% | 25.60% | 3.09% | 19.24% | 22.33% |
| 80/20 SPY/D+C | 90.29% | 1.39% | 3.20% | 5.12% | 80.61% | 3.85% | 84.47% |
| 60/40 SPY/D+C | 80.60% | 2.77% | 6.39% | 10.24% | 61.23% | 7.70% | 68.94% |
| 40/60 SPY/D+C | 70.90% | 4.16% | 9.58% | 15.36% | 41.86% | 11.55% | 53.41% |
