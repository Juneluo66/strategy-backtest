...
- Run: `/home/ec2-user/strategy-backtest/us_sector_equal_weight/reports/runs/20260814T024557Z_full-audit_8d9819022036`

## Gate: `DISCOVERY_ONLY` (8/13)
...
- Notes: `{'pseudo_oos_win_frac': '0/5', 'endpoint_win_frac': '7/7', 'cagr_edge_vs_rsp': '-0.02175654480383349', 'prefer_lower_turnover_if_false': 'If monthly_covers_extra_cost_vs_q_a is false, prefer quarterly/annual; do not pick frequency by max historical CAGR alone.'}`
- RSP similarity: `None`
...
- Bootstrap: `{'status': 'OK', 'n_boot': 500, 'block': 21, 'mean_edge': 0.0010076501706738426, 'p05': -0.012746907447871724, 'p50': 0.0008608836613948068, 'p95': 0.01451108439170133, 'frac_positive': 0.538}`

## French external mechanism validation

- FAILED: `no French daily rows parsed`
