...
> Full-sample Σdaily active: **A (risk-on)** adds most edge because static already holds 56% QQQ — going 100% SHY when BTC is off often *underperforms* static in long bull runs. **B (risk-off)** dominates arithmetic active in bear (QQQ≤200DMA) and high-VIX regimes, and in crisis years (e.g. 2022).
...
Judgment: **`BTC_BEATS_FROZEN_QQQ_200DMA_ON_RISK_ADJ`**
...
| QQQ_200DMA_SHY_adj_0bps | 16.50% | 1.002 | 16.70% | -25.18% | 0.82 |
| 100pct_QQQ | 18.82% | 0.902 | 21.86% | -35.12% | 1.00 |

BTC vs QQQ200DMA: ΔCAGR `0.80` pp, ΔSharpe `0.360`, ΔMaxDD `8.93` pp
