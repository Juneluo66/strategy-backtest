...
| Local BH QQQ Adj | 0.902 |
| Local BH QQQ Adj + rf 2% | 0.810 |
| Local BH QQQ Close | 0.867 |
| QC reported BH QQQ | 0.682 |

- Strat/QQQ Sharpe ratio QC reported: `1.229`
- Strat/QQQ Sharpe ratio local ours: `1.354`
- Strat/QQQ Sharpe ratio local QC-proxy: `1.511`
...
- `bh_qqq_adj`: Sharpe `0.902` CAGR `18.82%` Vol `21.86%` MaxDD `-35.12%`
- `bh_qqq_close`: Sharpe `0.867` CAGR `17.93%` Vol `21.87%` MaxDD `-35.62%`
- `bh_spy_adj`: Sharpe `0.826` CAGR `13.76%` Vol `17.53%` MaxDD `-33.72%`
