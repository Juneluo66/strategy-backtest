...
Primary return driver: `mixed_or_neither`
...
- Leg attribution (net CAGR): long_low_MAX=0.0821, short_high_MAX=-0.2667; primary driver=mixed_or_neither.
...
**YES — buy one-month Sharadar only as a falsification budget for PIT membership + size-neutral. Free Sharpe is not proof of independent alpha; paid data is justified because size/delisting/PIT is the binding uncertainty.**
