...
3. That approx ended at `0.9842` (<1), while Metric C ends at `1.0487` (>1).
...
- Legacy final rel vs Metric C: `0.9842` vs `1.0487` (gap `0.0645`)
...
- Run: `/home/ec2-user/strategy-backtest/us_equity_strategy_research/reports/runs/20260813T082008Z_half_protect_relative_audit_c4e302924dcb`
